...
import DragDrop from 'anti/flex-layout/lib/DragDrop'
...
import SplitterNode from 'anti/flex-layout/model/SplitterNode'
...
import Splitter from 'anti/flex-layout/view/Splitter'
import Tab from 'anti/flex-layout/view/Tab'
import TabSet from 'anti/flex-layout/view/TabSet'
import BorderTabSet from 'anti/flex-layout/view/BorderTabSet'
...
class Layout extends React.Component<ILayoutProps, any> {
  ...
  /** @hidden @internal */
  updateRect = () => {
    const domRect = this.selfRef.current!.getBoundingClientRect()
  ...
  render() {
    ...
    return (
      <div ref={this.selfRef} className={layoutClass}>
        {tabSetComponents}
        {this.tabIds.map(t => {
